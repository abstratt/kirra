...
This is a generic ng-admin application that builds the UI dynamically based on the application schema that is discovered using the [back-end (Kirra-based) REST API](../readme.md).
